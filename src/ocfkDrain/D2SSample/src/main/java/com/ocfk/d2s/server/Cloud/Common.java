...
public class Common {
    ...
    public static String HOST               = "coap+tcp://223.171.38.193:5683";
    public static String HOSTS               = "coap+tcp://192.168.0.1:5683";
    public static final String COAP_TCP           = "coap+tcp://";
    public static final String COAPS_TCP          = "coaps+tcp://";
    public static String TCP_ADDRESS        = "223.171.38.193";
    public static String TCP_PORT           = "5683";
    public static String TTA_TCP_ADDRESS        = "172.0.0.1";
    public static String TTA_TCP_PORT           = "5683";
    public static String AUTH_PROVIDER  ="github";
    ...
    public static final String CRT_FILE = "rootca_.crt";
